...
(() => {
  ...
  var require_barba_umd = __commonJS({
    "node_modules/@barba/core/dist/barba.umd.js"(exports, module) {
      ...
      !function(t2, n2) {
        ...
        function n2(n3, r2, e3) {
          return r2 && t2(n3.prototype, r2), e3 && t2(n3, e3), n3;
        }
        function r() {
          return (r = Object.assign || function(t3) {
            for (var n3 = 1; n3 < arguments.length; n3++) {
              var r2 = arguments[n3];
              for (var e3 in r2)
                Object.prototype.hasOwnProperty.call(r2, e3) && (t3[e3] = r2[e3]);
            }
            return t3;
        ...
        function u(t3, n3, r2) {
          ...
          }() ? Reflect.construct : function(t4, n4, r3) {
            var e3 = [null];
            e3.push.apply(e3, n4);
            var i3 = new (Function.bind.apply(t4, e3))();
            return r3 && o2(i3, r3.prototype), i3;
        ...
        function f(t3) {
          ...
          return (f = function(t4) {
            ...
            return r2.prototype = Object.create(t4.prototype, { constructor: { value: r2, enumerable: false, writable: true, configurable: true } }), o2(r2, t4);
          })(t3);
        }
        function s2(t3, n3) {
          try {
        ...
        var v = c.off, l = function() {
          ...
          return n3.error = function() {
            for (var t4 = arguments.length, n4 = new Array(t4), r2 = 0; r2 < t4; r2++)
              n4[r2] = arguments[r2];
          ...
          }, n3.i = function(n4, r2, e3) {
            r2 <= t3.getLevel() && n4.apply(console, ["[" + this.t + "] "].concat(e3));
          }, t3;
        }(), d = O, m = E, p = g, w = x, b = T, y = "/", P = new RegExp(["(\\\\.)", "(?:\\:(\\w+)(?:\\(((?:\\\\.|[^\\\\()])+)\\))?|\\(((?:\\\\.|[^\\\\()])+)\\))([+*?])?"].join("|"), "g");
        function g(t3, n3) {
          for (var r2, e3 = [], i3 = 0, o3 = 0, u2 = "", f2 = n3 && n3.delimiter || y, s3 = n3 && n3.whitelist || void 0, c2 = false; null !== (r2 = P.exec(t3)); ) {
        ...
        function x(t3, n3) {
          for (var r2 = new Array(t3.length), e3 = 0; e3 < t3.length; e3++)
            "object" == typeof t3[e3] && (r2[e3] = new RegExp("^(?:" + t3[e3].pattern + ")$", R(n3)));
              ...
              if ("string" != typeof s3) {
                ...
                if (Array.isArray(a2)) {
                  ...
                  for (var h2 = 0; h2 < a2.length; h2++) {
                    if (c2 = o3(a2[h2], s3), u2 && !r2[f2].test(c2))
                  ...
                  if (c2 = o3(String(a2), s3), u2 && !r2[f2].test(c2))
        ...
        function T(t3, n3, r2) {
          for (var e3 = (r2 = r2 || {}).strict, i3 = false !== r2.start, o3 = false !== r2.end, u2 = r2.delimiter || y, f2 = [].concat(r2.endsWith || []).map(k).concat("$").join("|"), s3 = i3 ? "^" : "", c2 = 0; c2 < t3.length; c2++) {
            var a2 = t3[c2];
            if ("string" == typeof a2)
              s3 += k(a2);
            else {
          ...
          return new RegExp(s3, R(r2));
        }
        function O(t3, n3, r2) {
          return t3 instanceof RegExp ? function(t4, n4) {
            if (!n4)
              return t4;
            var r3 = t4.source.match(/\((?!\?)/g);
            if (r3)
              for (var e3 = 0; e3 < r3.length; e3++)
                n4.push({ name: e3, prefix: null, delimiter: null, optional: false, repeat: false, pattern: null });
            return t4;
          }(t3, n3) : Array.isArray(t3) ? function(t4, n4, r3) {
            for (var e3 = [], i3 = 0; i3 < t4.length; i3++)
              e3.push(O(t4[i3], n4, r3).source);
            return new RegExp("(?:" + e3.join("|") + ")", R(r3));
          }(t3, n3, r2) : function(t4, n4, r3) {
            return T(g(t4, r3), n4, r3);
          }(t3, n3, r2);
        }
        d.match = function(t3, n3) {
          var r2 = [];
          return E(O(t3, r2, n3), r2);
        ...
        var S = { container: "container", history: "history", namespace: "namespace", prefix: "data-barba", prevent: "prevent", wrapper: "wrapper" }, j = new (function() {
          ...
          return n3.toString = function(t4) {
            ...
            r2 ? this.s(t4, r2) : n4.appendChild(t4);
          ...
          return e3.init = function(t4, n3) {
            this.l = "barba";
            var r2 = { ns: n3, scroll: { x: window.scrollX, y: window.scrollY }, url: t4 };
            this.h.push(r2), this.v = 0;
            var e4 = { from: this.l, index: 0, states: [].concat(this.h) };
            window.history && window.history.replaceState(e4, "", t4);
          }, e3.change = function(t4, n3, r2) {
            if (r2 && r2.state) {
              var e4 = r2.state, i3 = e4.index;
              n3 = this.m(this.v - i3), this.replace(e4.states), this.v = i3;
            } else
              this.add(t4, n3);
            return n3;
          }, e3.add = function(t4, n3) {
            var r2 = this.size, e4 = this.p(n3), i3 = { ns: "tmp", scroll: { x: window.scrollX, y: window.scrollY }, url: t4 };
            this.h.push(i3), this.v = r2;
            var o3 = { from: this.l, index: r2, states: [].concat(this.h) };
            switch (e4) {
              case "push":
            ...
            var e4 = n3 || this.v, i3 = r({}, this.get(e4), {}, t4);
            this.set(e4, i3);
            ...
            var n3 = "push", r2 = t4, e4 = S.prefix + "-" + S.history;
            return r2.hasAttribute && r2.hasAttribute(e4) && (n3 = r2.getAttribute(e4)), n3;
          }, e3.m = function(t4) {
              ...
              if (!n3.next.html)
                return Promise.resolve(t3).then(function(t4) {
                  ...
                  if (t4) {
                    ...
                    r3.namespace = j.getNamespace(e3), r3.container = j.getContainer(e3), r3.html = t4, M.update({ ns: r3.namespace });
          ...
          var n3, r2 = t3.match(/:\d+/);
          if (null === r2)
            /^http/.test(t3) && (n3 = 80), /^https/.test(t3) && (n3 = 443);
          else {
            var e3 = r2[0].substring(1);
            n3 = parseInt(e3, 10);
          }
        ...
        function N(t3, n3) {
          return void 0 === n3 && (n3 = {}), function() {
            for (var r2 = arguments.length, e3 = new Array(r2), i3 = 0; i3 < r2; i3++)
              e3[i3] = arguments[i3];
            var o3 = false, u2 = new Promise(function(r3, i4) {
              n3.async = function() {
        ...
        var X = new (function(t3) {
          ...
          return r2.init = function() {
            ...
            this.registered.clear(), this.all.forEach(function(n4) {
              t4[n4] || (t4[n4] = function(r3, e3) {
                t4.registered.has(n4) || t4.registered.set(n4, /* @__PURE__ */ new Set()), t4.registered.get(n4).add({ ctx: e3 || {}, fn: r3 });
              });
            });
          }, r2.do = function(t4) {
            for (var n4 = this, r3 = arguments.length, e3 = new Array(r3 > 1 ? r3 - 1 : 0), i3 = 1; i3 < r3; i3++)
            ...
            if (this.registered.has(t4)) {
              ...
              }), o3.catch(function(r4) {
                n4.logger.debug("Hook error [" + t4 + "]"), n4.logger.error(r4);
              });
            }
          ...
          function n3(n4) {
            var r2;
            return (r2 = t3.call(this, n4) || this).k = /* @__PURE__ */ new Map(), r2;
          }
          e2(n3, t3);
          var i3 = n3.prototype;
          return i3.set = function(t4, n4, r2) {
            return this.k.set(t4, { action: r2, request: n4 }), { action: r2, request: n4 };
          }, i3.get = function(t4) {
          ...
          function n3(n4) {
            var r3;
            return (r3 = t3.call(this, n4) || this).suite = [], r3.tests = /* @__PURE__ */ new Map(), r3.init(), r3;
          }
          e2(n3, t3);
          var r2 = n3.prototype;
          return r2.init = function() {
          ...
          }, r2.add = function(t4, n4, r3) {
            void 0 === r3 && (r3 = true), this.tests.set(t4, n4), r3 && this.suite.push(t4);
          }, r2.run = function(t4, n4, r3, e3) {
            return this.tests.get(t4)({ el: n4, event: r3, href: e3 });
          }, r2.checkLink = function(t4, n4, r3) {
            var e3 = this;
            return this.suite.some(function(i3) {
              return e3.run(i3, t4, n4, r3);
            });
          }, n3;
        }(z), it = function(t3) {
          function n3(r2, e3) {
            ...
            return (i3 = t3.call.apply(t3, [this].concat(u2)) || this).error = r2, i3.label = e3, Error.captureStackTrace && Error.captureStackTrace(function(t4) {
              if (void 0 === t4)
          ...
          return n3.add = function(t4, n4) {
            ...
            var i3 = /* @__PURE__ */ new Map(), o3 = e3.find(function(e4) {
              var o4 = true, u3 = {};
              return !(!n4.self || "self" !== e4.name) || (r2.A.reverse().forEach(function(n5) {
                o4 && (o4 = r2.R(e4, n5, t4, u3), e4.from && e4.to && (o4 = r2.R(e4, n5, t4, u3, "from") && r2.R(e4, n5, t4, u3, "to")), e4.from && !e4.to && (o4 = r2.R(e4, n5, t4, u3, "from")), !e4.from && e4.to && (o4 = r2.R(e4, n5, t4, u3, "to")));
              }), i3.set(e4, u3), o4);
            }), u2 = i3.get(o3), f2 = [];
          ...
          }, n3.R = function(t4, n4, r2, e3, i3) {
            var o3 = true, u2 = false, f2 = t4, s3 = n4.name, c2 = s3, a2 = s3, h2 = s3, v2 = i3 ? f2[i3] : f2, l2 = "to" === i3 ? r2.next : r2.current;
            if (i3 ? v2 && v2[s3] : v2[s3]) {
              switch (n4.type) {
                ...
                case "object":
                  ...
                  break;
                case "function":
                  v2[h2](r2) ? u2 = true : o3 = false;
              }
              u2 && (i3 ? (e3[i3] = e3[i3] || {}, e3[i3][s3] = f2[i3][s3]) : e3[s3] = f2[s3]);
            }
            return o3;
          }, n3.O = function(t4, n4, r2) {
            var e3 = 0;
            return (t4[n4] || t4.from && t4.from[n4] || t4.to && t4.to[n4]) && (e3 += Math.pow(10, r2), t4.from && t4.from[n4] && (e3 += 1), t4.to && t4.to[n4] && (e3 += 2)), e3;
          }, n3.T = function(t4) {
            var n4 = this;
            t4.priority = 0;
            var r2 = 0;
            return this.A.forEach(function(e3, i3) {
              r2 += n4.O(t4, e3.name, i3 + 1);
            }), t4.priority = r2, t4;
          }, t3;
        }(), ut = function() {
          function t3(t4) {
          ...
          var r2 = t3.prototype;
          return r2.get = function(t4, n3) {
            return this.store.resolve(t4, n3);
          }, r2.doOnce = function(t4) {
            var n3 = t4.data, r3 = t4.transition;
            try {
              var e3 = function() {
                i3.S = false;
              }, i3 = this, o3 = r3 || {};
            ...
            var n3 = t4.data, r3 = t4.transition, e3 = t4.page, i3 = t4.wrapper;
            try {
              var o3 = function(t5) {
                if (u2)
                  return t5;
              ...
              var h2 = s2(function() {
                function t5() {
                  return Promise.resolve(f2.j("before", n3, c2)).then(function() {
                    var t6 = false;
                    function r5(r6) {
                      return t6 ? r6 : Promise.resolve(f2.remove(n3)).then(function() {
                    ...
                    return o4 && o4.then ? o4.then(r5) : r5(o4);
                  });
                }
                var r4 = function() {
                  if (a2)
          ...
          }, r2.enter = function(t4, n3, r3) {
            try {
              return Promise.resolve(X.do("enter", t4, n3)).then(function() {
                return n3.enter ? N(n3.enter, n3)(t4, r3) : Promise.resolve();
              });
            } catch (t5) {
              return Promise.reject(t5);
            }
          }, r2.add = function(t4, n3) {
            try {
          ...
          }, r2.j = function(t4, n3, r3) {
            try {
              return Promise.resolve(X.do(t4, n3, r3)).then(function() {
                return r3[t4] ? N(r3[t4], r3)(n3) : Promise.resolve();
              });
            } catch (t5) {
              return Promise.reject(t5);
            }
          ...
          return t3.prototype.L = function(t4) {
            var n3 = this;
            return function(r2) {
              var e3 = t4.match(/enter/i) ? r2.next : r2.current, i3 = n3.byNamespace.get(e3.namespace);
              return i3 && i3[t4] ? N(i3[t4], i3)(r2) : Promise.resolve();
            };
          }, t3;
        }();
        ...
        return new (function() {
          ...
          return e3.use = function(t4, n3) {
            var r2 = this.plugins;
            r2.indexOf(t4) > -1 ? this.logger.warn("Plugin [" + t4.name + "] already installed.") : "function" == typeof t4.install ? (t4.install(this, n3), r2.push(t4)) : this.logger.warn("Plugin [" + t4.name + '] has no "install" method.');
          }, e3.init = function(t4) {
            ...
            if (void 0 === n3 && (n3 = "barba"), this.transitions.isRunning)
              ...
              return n3 = this.history.change(t4, n3, r2), r2 && (r2.stopPropagation(), r2.preventDefault()), this.page(t4, n3, e4);
          }, e3.once = function(t4) {
            try {
              var n3 = this;
              return Promise.resolve(n3.hooks.do("beforeEnter", t4)).then(function() {
                ...
                var e4 = function() {
                  if (n3.transitions.hasOnce) {
                    var r3 = n3.transitions.get(t4, { once: true });
                    return Promise.resolve(n3.transitions.doOnce({ transition: r3, data: t4 })).then(function() {
                    });
                  }
                }();
                return e4 && e4.then ? e4.then(r2) : r2();
              });
            } catch (t5) {
              return Promise.reject(t5);
            }
            ...
            try {
              ...
              o3.data.next.url = r({ href: t4 }, o3.url.parse(t4)), o3.data.trigger = n3;
            ...
            for (var n3 = arguments.length, r2 = new Array(n3 > 1 ? n3 - 1 : 0), e4 = 1; e4 < n3; e4++)
              r2[e4 - 1] = arguments[e4];
            var i3 = r2[0], o3 = r2[1], u2 = this.cache.getAction(i3);
            ...
            var n3 = this, r2 = this.I(t4);
            if (r2) {
              var e4 = this.dom.getHref(r2);
              this.prevent.checkHref(e4) || this.cache.has(e4) || this.cache.set(e4, this.request(e4, this.timeout, this.onRequestError.bind(this, r2)).catch(function(t5) {
                n3.logger.error(t5);
              }), "enter");
            }
          }, e3.U = function(t4) {
            ...
            var t4 = this.url.getHref(), n3 = { container: this.dom.getContainer(), html: this.dom.getHtml(), namespace: this.dom.getNamespace(), url: r({ href: t4 }, this.url.parse(t4)) };
      ...
      if (keyframes || stagger || _isFuncOrString(duration2) || _isFuncOrString(delay)) {
        ...
        if (stagger || _isFuncOrString(duration2) || _isFuncOrString(delay)) {
          ...
          for (i2 = 0; i2 < l; i2++) {
            ...
            copy.duration = +_parseFuncOrString(duration2, _assertThisInitialized(_this3), i2, curTarget, parsedTargets);
          ...
          if (_isArray(keyframes)) {
            ...
            for (p in copy) {
              ...
              for (i2 = 0; i2 < a.length; i2++) {
                ...
                v = {
                  ease: kf.e,
                  duration: (kf.t - (i2 ? a[i2 - 1].t : 0)) / 100 * duration2
                };
                v[p] = kf.v;
  ...
  init_live_reload();
  var togglePlayMotion = (isPlaying) => {
  ...
  // src/components/cursor.ts
  var cursor2 = document.querySelector(".cursor_component");
  var cursorMovement = () => {
    gsapWithCSS.set(cursor2, { xPercent: -50, yPercent: -50 });
  ...
  var cursorHover = () => {
    ...
    for (let i2 = 0; i2 < cursorAreas.length; i2++) {
      const area = cursorAreas[i2];
      const scale2 = Number(area.dataset.hoverScale);
      const iconType = area.dataset.hoverIcon;
      area.addEventListener("mouseenter", () => {
        cursorRevealIn(scale2);
        if (iconType !== void 0) {
          const areaIcon = getAreaIcon(iconType);
  ...
  init_live_reload();
  var generateHubspotJSON = (formData, target) => {
    ...
    for (let i2 = 0; i2 < formInputs.length; i2++) {
      const tempInput = formInputs[i2];
  ...
  init_live_reload();
  var postContactData = (data, target) => {
    $.ajax({
      url: target.action,
      method: "POST",
      data,
  ...
  var _parseRect = function _parseRect2(e2) {
    ...
    } : !e2.nodeType && !_isUndefined3(e2.left) && !_isUndefined3(e2.top) ? e2 : _toArray2(e2)[0].getBoundingClientRect();
  ...
  var _getBounds = function _getBounds2(target, context3) {
    var e2 = _toArray2(target)[0], top, left, offset;
  ...
  var Draggable = /* @__PURE__ */ function(_EventDispatcher) {
    ...
    function Draggable2(target, vars) {
      ...
      var type = (vars.type || "x,y").toLowerCase(), xyMode = ~type.indexOf("x") || ~type.indexOf("y"), rotationMode = type.indexOf("rotation") !== -1, xProp = rotationMode ? "rotation" : xyMode ? "x" : "left", yProp = xyMode ? "y" : "top", allowX = !!(~type.indexOf("x") || ~type.indexOf("left") || type === "scroll"), allowY = !!(~type.indexOf("y") || ~type.indexOf("top") || type === "scroll"), minimumMovement = vars.minimumMovement || 2, self2 = _assertThisInitialized2(_this2), triggers = _toArray2(vars.trigger || vars.handle || target), killProps = {}, dragEndTime = 0, checkAutoScrollBounds = false, autoScrollMarginTop = vars.autoScrollMarginTop || 40, autoScrollMarginRight = vars.autoScrollMarginRight || 40, autoScrollMarginBottom = vars.autoScrollMarginBottom || 40, autoScrollMarginLeft = vars.autoScrollMarginLeft || 40, isClickable = vars.clickableTest || _isClickable, clickTime = 0, gsCache = target._gsap || gsap3.core.getCache(target), isFixed = _isFixed3(target), getPropAsNum = function getPropAsNum2(property, unit) {
        ...
        var originalEvent = e2, wasDragging = self2.isDragging, isContextMenuRelease = self2.vars.allowContextMenu && e2 && (e2.ctrlKey || e2.which > 2), placeholderDelayedCall = gsap3.delayedCall(1e-3, removePlaceholder), touches, i2, syntheticEvent, eventTarget, syntheticClick;
        if (touchEventTarget) {
      ...
      _context3(_assertThisInitialized2(_this2));
      _this2.enable();
      return _this2;
    }
  ...
  _getGSAP() && gsap3.registerPlugin(Draggable);
  ...
  var VelocityTracker = /* @__PURE__ */ function() {
    ...
    VelocityTracker2.track = function track(targets, properties, types) {
      ...
      var result = [], targs = _toArray3(targets), a = properties.split(","), t2 = (types || "").split(","), i2 = targs.length, tracker, j;
      while (i2--) {
  ...
  var _getClosest = function _getClosest2(n2, values, max, min, radius) {
    var i2 = values.length, closest = 0, absDif = _bigNum4, val, dif, p, dist;
    if (_isObject5(n2)) {
      while (i2--) {
        val = values[i2];
        dif = 0;
  ...
  var _calculateChange = function _calculateChange2(velocity, duration2) {
    return duration2 * _checkPoint * velocity / _checkPointRatio;
  };
  ...
  var _processLinkedProps = function _processLinkedProps2(target, vars, getVal, resistance) {
    if (vars.linkedProps) {
      var linkedPropNames = vars.linkedProps.split(","), linkedProps = {}, i2, p, curProp, curVelocity, tracker, curDuration;
      for (i2 = 0; i2 < linkedPropNames.length; i2++) {
        p = linkedPropNames[i2];
        curProp = vars[p];
        if (curProp) {
  ...
  var _calculateTweenDuration = function _calculateTweenDuration2(target, vars, maxDuration, minDuration, overshootTolerance, recordEnd) {
    ...
    var duration2 = 0, clippedDuration = _bigNum4, inertiaVars = vars.inertia || vars, getVal = _getCache4(target).get, resistance = _getNumOrDefault(inertiaVars, "resistance", _config2.resistance), p, curProp, curDuration, curVelocity, curVal, end, curClippedDuration, tracker, unitFactor, linkedProps;
    ...
    for (p in inertiaVars) {
      if (!_reservedProps2[p]) {
        ...
        if (_isObject5(curProp)) {
          ...
          curClippedDuration > duration2 && (duration2 = curClippedDuration);
        }
        curDuration > duration2 && (duration2 = curDuration);
      }
    }
    duration2 > clippedDuration && (duration2 = clippedDuration);
    return duration2 > maxDuration ? maxDuration : duration2 < minDuration ? minDuration : duration2;
  };
  ...
  var InertiaPlugin2 = {
    ...
    init: function init4(target, vars, tween, index, targets) {
      ...
      var cache = target._gsap, getVal = cache.get, dur = vars.duration, durIsObj = _isObject5(dur), preventOvershoot = vars.preventOvershoot || durIsObj && dur.overshoot === 0, resistance = _getNumOrDefault(vars, "resistance", _config2.resistance), duration2 = _isNumber3(dur) ? dur : _calculateTweenDuration(target, vars, durIsObj && dur.max || 10, durIsObj && dur.min || 0.2, durIsObj && "overshoot" in dur ? +dur.overshoot : preventOvershoot ? 0 : 1, true), p, curProp, curVal, unit, velocity, change1, end, change2, linkedProps;
      ...
      for (p in vars) {
        if (!_reservedProps2[p]) {
          ...
          change1 = _calculateChange(velocity, duration2);
          change2 = 0;
  ...
  var draggableSlider = () => {
    ...
    const sliderContainer = document.querySelector(".about-team_list");
  ...
  var _getTarget = function _getTarget2(t2) {
    return gsap6.utils.toArray(t2)[0] || (typeof t2 === "string" && gsap6.config().nullTargetWarn !== false ? console.warn("Element not found:", t2) : null);
  };
  var _getScrollFunc = function _getScrollFunc2(element, _ref) {
    ...
    func.target = element;
    prev || (func.smooth = gsap6.getProperty(element, "scrollBehavior") === "smooth");
    return func;
  };
  ...
  var _initCore11 = function _initCore12(core) {
    ...
    if (gsap6 && typeof document !== "undefined" && document.body) {
      _win6 = window;
      _doc6 = document;
  ...
  var Observer = /* @__PURE__ */ function() {
    ...
    _proto.init = function init6(vars) {
      _coreInitted6 || _initCore11(gsap6) || console.warn("Please gsap.registerPlugin(Observer)");
      ...
      this.vars = vars;
      ignore && (ignore = gsap6.utils.toArray(ignore));
      ...
      var id, onStopDelayedCall, dragged, moved, wheeled, locked, axis, self2 = this, prevDeltaX = 0, prevDeltaY = 0, scrollFuncX = _getScrollFunc(target, _horizontal), scrollFuncY = _getScrollFunc(target, _vertical), scrollX = scrollFuncX(), scrollY = scrollFuncY(), limitToTouch = ~type.indexOf("touch") && !~type.indexOf("pointer") && _eventTypes[0] === "pointerdown", isViewport = _isViewport(target), ownerDoc = target.ownerDocument || _doc6, deltaX = [0, 0, 0], deltaY = [0, 0, 0], onClickTime = 0, clickCapture = function clickCapture2() {
        ...
        if (!wasDragging && isTrackingDrag) {
          ...
          if (preventDefault && allowClicks) {
            gsap6.delayedCall(0.08, function() {
      ...
      onStopDelayedCall = self2._dc = gsap6.delayedCall(onStopDelay || 0.25, onStopFunc).pause();
      self2.deltaX = self2.deltaY = 0;
  ...
  _getGSAP7() && gsap6.registerPlugin(Observer);
  ...
  var _maxScroll = function _maxScroll2(element, _ref2) {
    ...
    return (s2 = "scroll" + d2) && (a = _getProxyProp(element, s2)) ? a() - _getBoundsFunc(element)()[d] : _isViewport3(element) ? (_docEl2[s2] || _body4[s2]) - (_win7["inner" + d2] || _docEl2["client" + d2] || _body4["client" + d2]) : element[s2] - element["offset" + d2];
  };
  ...
  var _getBounds3 = function _getBounds4(element, withoutTransforms) {
    var tween = withoutTransforms && _getComputedStyle5(element)[_transformProp4] !== "matrix(1, 0, 0, 1, 0, 0)" && gsap7.to(element, {
      x: 0,
      y: 0,
      xPercent: 0,
      yPercent: 0,
  ...
  var _snapDirectional = function _snapDirectional2(snapIncrementOrArray) {
    var snap3 = gsap7.utils.snap(snapIncrementOrArray), a = Array.isArray(snapIncrementOrArray) && snapIncrementOrArray.slice(0).sort(function(a2, b) {
      return a2 - b;
    });
  ...
  var _setState = function _setState2(state) {
    if (state) {
      ...
      (state.t._gsap || gsap7.core.getCache(state.t)).uncache = 1;
      for (; i2 < l; i2 += 2) {
        value = state[i2 + 1];
        p = state[i2];
        if (value) {
  ...
  var _parsePosition3 = function _parsePosition4(value, trigger, scrollerSize, direction, scroll, marker, markerScroller, self2, scrollerBounds, borderWidth, useFixedPosition, scrollerMax, containerAnimation) {
    _isFunction7(value) && (value = value(self2));
    ...
    if (!_isNumber5(value)) {
      _isFunction7(trigger) && (trigger = trigger(self2));
  ...
  var _reparent = function _reparent2(element, parent, top, left) {
    if (element.parentNode !== parent) {
      ...
      gsap7.core.getCache(element).uncache = 1;
  ...
  var _getTweenCreator = function _getTweenCreator2(scroller, direction) {
    var getScroll = _getScrollFunc(scroller, direction), prop = "_scroll" + direction.p2, lastScroll1, lastScroll2, getTween = function getTween2(scrollTo, vars, initialValue, change1, change2) {
      ...
      tween = getTween2.tween = gsap7.to(scroller, vars);
      return tween;
    };
  ...
  var ScrollTrigger2 = /* @__PURE__ */ function() {
    ...
    _proto.init = function init6(vars, animation) {
      ...
      var _vars = vars, onUpdate = _vars.onUpdate, toggleClass = _vars.toggleClass, id = _vars.id, onToggle = _vars.onToggle, onRefresh = _vars.onRefresh, scrub = _vars.scrub, trigger = _vars.trigger, pin = _vars.pin, pinSpacing = _vars.pinSpacing, invalidateOnRefresh = _vars.invalidateOnRefresh, anticipatePin = _vars.anticipatePin, onScrubComplete = _vars.onScrubComplete, onSnapComplete = _vars.onSnapComplete, once = _vars.once, snap3 = _vars.snap, pinReparent = _vars.pinReparent, pinSpacer = _vars.pinSpacer, containerAnimation = _vars.containerAnimation, fastScrollEnd = _vars.fastScrollEnd, preventOverlaps = _vars.preventOverlaps, direction = vars.horizontal || vars.containerAnimation && vars.horizontal !== false ? _horizontal : _vertical, isToggle = !scrub && scrub !== 0, scroller = _getTarget(vars.scroller || _win7), scrollerCache = gsap7.core.getCache(scroller), isViewport = _isViewport3(scroller), useFixedPosition = ("pinType" in vars ? vars.pinType : _getProxyProp(scroller, "pinType") || isViewport && "fixed") === "fixed", callbacks = [vars.onEnter, vars.onLeave, vars.onEnterBack, vars.onLeaveBack], toggleActions = isToggle && vars.toggleActions.split(" "), markers = "markers" in vars ? vars.markers : _defaults2.markers, borderWidth = isViewport ? 0 : parseFloat(_getComputedStyle5(scroller)["border" + direction.p2 + _Width]) || 0, self2 = this, onRefreshInit = vars.onRefreshInit && function() {
      ...
      if (snap3) {
        ...
        "scrollBehavior" in _body4.style && gsap7.set(isViewport ? [_body4, _docEl2] : scroller, {
          scrollBehavior: "auto"
        });
      ...
      if (pin) {
        ...
        self2.pin = pin;
        pinCache = gsap7.core.getCache(pin);
        if (!pinCache.spacer) {
          if (pinSpacer) {
        ...
        vars.force3D !== false && gsap7.set(pin, {
          force3D: true
        });
        self2.spacer = spacer = pinCache.spacer;
        cs = _getComputedStyle5(pin);
        spacingStart = cs[pinSpacing + direction.os2];
        pinGetter = gsap7.getProperty(pin);
        pinSetter = gsap7.quickSetter(pin, direction.a, _px);
      ...
      if (markers) {
        ...
        containerAnimation && (caMarkerSetter = gsap7.quickSetter([markerStart, markerEnd], direction.a, _px));
        if (!useFixedPosition && !(_proxies.length && _getProxyProp(scroller, "fixedMarkers") === true)) {
          _makePositionable(isViewport ? _body4 : scroller);
          gsap7.set([markerStartTrigger, markerEndTrigger], {
            force3D: true
          });
          markerStartSetter = gsap7.quickSetter(markerStartTrigger, direction.a, _px);
          markerEndSetter = gsap7.quickSetter(markerEndTrigger, direction.a, _px);
        }
      }
        ...
        if (r !== self2.isReverted) {
          ...
          if (pin && (!pinReparent || !self2.isActive)) {
            if (r) {
              ...
              _swapPinIn(pin, spacer, _getComputedStyle5(pin), spacerState);
            }
          }
          r || self2.update(r);
      ...
      self2.refresh = function(soft, force) {
        ...
        _isFunction7(parsedStart) && (parsedStart = parsedStart(self2));
        ...
        _isFunction7(parsedEnd) && (parsedEnd = parsedEnd(self2));
        ...
        if (markerStart && offset2) {
          ...
          gsap7.set([markerStart, markerEnd], cs2);
        }
        if (pin) {
          ...
          if (!max && end > 1) {
            forcedOverflow = (isViewport ? _doc7.scrollingElement || _docEl2 : scroller).style;
            forcedOverflow = {
      ...
      self2.update = function(reset, recordVelocity, forceFake) {
        ...
        if (clipped !== prevProgress2 && self2.enabled) {
          ...
          preventOverlaps && (toggled || isTakingAction) && (isTakingAction || scrub || !animation) && (_isFunction7(preventOverlaps) ? preventOverlaps(self2) : self2.getTrailing(preventOverlaps).forEach(function(t2) {
      ...
      !animation || !animation.add || change ? self2.refresh() : gsap7.delayedCall(0.01, function() {
    ...
    ScrollTrigger4.enable = function enable() {
      ...
      if (gsap7) {
        ...
        _context5 = gsap7.core.context || _passThrough3;
        _suppressOverwrites2 = gsap7.core.suppressOverwrites || _passThrough3;
        _scrollRestoration = _win7.history.scrollRestoration || "auto";
        gsap7.core.globals("ScrollTrigger", ScrollTrigger4);
        if (_body4) {
          _enabled = 1;
          Observer.register(gsap7);
          ...
          if (gsap7.matchMedia) {
            ScrollTrigger4.matchMedia = function(vars) {
              var mm = gsap7.matchMedia(), p;
              for (p in vars) {
                mm.add(p, vars[p]);
              }
              return mm;
            };
            gsap7.addEventListener("matchMediaInit", function() {
              return _revertAll();
            });
            gsap7.addEventListener("matchMediaRevert", function() {
              return _revertRecorded();
            });
            gsap7.addEventListener("matchMedia", function() {
              _refreshAll(0, 1);
              _dispatch3("matchMedia");
            });
            gsap7.matchMedia("(orientation: portrait)", function() {
              _setBaseDimensions();
          ...
          var bodyStyle = _body4.style, border = bodyStyle.borderTopStyle, AnimationProto = gsap7.core.Animation.prototype, bounds, i2;
          ...
          gsap7.delayedCall(0.5, function() {
            return _startup2 = 0;
          });
          ...
          _transformProp4 = gsap7.utils.checkPrefix("transform");
          _stateProps.push(_transformProp4);
          _coreInitted7 = _getTime3();
          _resizeDelay = gsap7.delayedCall(0.2, _refreshAll).pause();
  ...
  ScrollTrigger2.saveStyles = function(targets) {
    return targets ? _toArray5(targets).forEach(function(target) {
      if (target && target.style) {
        ...
        _savedStyles.push(target, target.style.cssText, target.getBBox && target.getAttribute("transform"), gsap7.core.getCache(target), _context5());
      }
    }) : _savedStyles;
  };
  ...
  ScrollTrigger2.batch = function(targets, vars) {
    var result = [], varsCopy = {}, interval = vars.interval || 0.016, batchMax = vars.batchMax || 1e9, proxyCallback = function proxyCallback2(type, callback) {
      var elements = [], triggers = [], delay = gsap7.delayedCall(interval, function() {
  ...
  var _nestedScroll = function _nestedScroll2(_ref5) {
    ...
    var node = (event.changedTouches ? event.changedTouches[0] : event).target, cache = node._gsap || gsap7.core.getCache(node), time = _getTime3(), cs;
    if (!cache._isScrollT || time - cache._isScrollT > 2e3) {
      while (node && node !== _body4 && (node.scrollHeight <= node.clientHeight && node.scrollWidth <= node.clientWidth || !(_overflow[(cs = _getComputedStyle5(node)).overflowY] || _overflow[cs.overflowX]))) {
        node = node.parentNode;
      }
      cache._isScroll = node && node !== target && !_isViewport3(node) && (_overflow[(cs = _getComputedStyle5(node)).overflowY] || _overflow[cs.overflowX]);
  ...
  var _getScrollNormalizer = function _getScrollNormalizer2(vars) {
    ...
    var _vars2 = vars, normalizeScrollX = _vars2.normalizeScrollX, momentum = _vars2.momentum, allowNestedScroll = _vars2.allowNestedScroll, self2, maxY, target = _getTarget(vars.target) || _docEl2, smoother = gsap7.core.globals().ScrollSmoother, smootherInstance = smoother && smoother.get(), content = _fixIOSBug && (vars.content && _getTarget(vars.content) || smootherInstance && vars.content !== false && !smootherInstance.smooth() && smootherInstance.content()), scrollFuncY = _getScrollFunc(target, _vertical), scrollFuncX = _getScrollFunc(target, _horizontal), scale2 = 1, initialScale = (Observer.isTouch && _win7.visualViewport ? _win7.visualViewport.scale * _win7.visualViewport.width : _win7.outerWidth) / _win7.innerWidth, wheelRefresh = 0, resolveMomentumDuration = _isFunction7(momentum) ? function() {
    ...
    content && gsap7.set(content, {
      y: "+=0"
    });
    vars.ignoreCheck = function(e2) {
      return _fixIOSBug && e2.type === "touchmove" && ignoreDrag(e2) || scale2 > 1.05 && e2.type !== "touchstart" || self2.isGesturing || e2.touches && e2.touches.length > 1;
    };
    vars.onPress = function() {
      var prevScale = scale2;
      scale2 = _round9((_win7.visualViewport && _win7.visualViewport.scale || 1) / initialScale);
      tween.pause();
    ...
    _fixIOSBug && gsap7.ticker.add(_passThrough3);
    onStopDelayedCall = self2._dc;
    tween = gsap7.to(self2, {
      ease: "power4",
      paused: true,
  ...
  _getGSAP9() && gsap7.registerPlugin(ScrollTrigger2);
  ...
  var abClientsReveal = () => {
    ...
    const sortLogo = [];
    for (let i2 = 0; i2 < clientLogos.length; i2 += sortSize) {
  ...
  var caseScrollEffect = () => {
    ...
    const scrollSection = document.querySelector(".section_work");
  ...
  var filterContent = () => {
    ...
    for (const i2 in filterCheckboxes) {
      const tempCheckbox = filterCheckboxes[i2];
      tempCheckbox.addEventListener("click", (e2) => {
        ...
        const filterText = clickedSpan.innerHTML;
  ...
  function renderUpdate(items) {
    hideAll();
    for (const i2 in items) {
      items[i2].classList.remove("hide");
    }
  }
  function filterList(items, filters) {
    const filteredList = items.filter((item) => {
      const itemTemp = item;
      const itemType = itemTemp.querySelector("[data-filter-item-type]")?.innerHTML;
  ...
  function updateInitialCheckbox(initialFilter, setState) {
  ...
  function allReset() {
    const filterCheckboxes = [...document.querySelectorAll("[data-filter-checkbox]")];
    for (let i2 = 0; i2 < filterCheckboxes.length; i2++) {
      const temp = filterCheckboxes[i2];
      const tempParent = temp.parentElement;
      const tempContainer = tempParent.children[0];
      const tempText = tempParent.childNodes[2];
      if (i2 !== 0) {
        temp.checked = false;
  ...
  // src/components/cmsMediaGrid.ts
  init_live_reload();
  var cmsMediaGrid = () => {
    const mediaBlocks = [...document.querySelectorAll("[data-media-block]")];
    let setIndex = 0;
    for (let i2 = 0; i2 < mediaBlocks.length; i2++) {
      const tempMediaBlock = mediaBlocks[i2];
    ...
    function setMedia(block, index) {
      const feedContent = [...document.querySelectorAll(".content-feed_image")];
      const blockImageElement = block.children[0];
      const setImage = feedContent[index];
      blockImageElement.src = setImage.src;
      blockImageElement.srcset = setImage.srcset;
    }
    function isVideoSet(block) {
      const blockVideo = block.children[1];
      let videoSet = false;
      if (blockVideo !== void 0) {
  ...
  var initSliderImages = () => {
    ...
    for (let i2 = 0; i2 < useImages.length; i2++) {
      const temp = useImages[i2];
      if (i2 > 0) {
  ...
  init_live_reload();
  gsapWithCSS.registerPlugin(SplitText);
  var scrollTriggerStart4 = "top 70%";
  var scrollTriggerEnd4 = "top 70%";
  var device4 = getDeviceType();
  if (device4 === "tablet" || device4 === "mobile") {
    scrollTriggerStart4 = "top 80%";
    scrollTriggerEnd4 = "top 80%";
  }
  var csPageReveal = () => {
    const fixedHeaderSection = document.querySelector(".section_sticky-header");
  ...
  var contactHover = () => {
    ...
    if (device10 === "desktop") {
      ...
      for (const i2 in contactLinksWraps) {
        const tempWrap = contactLinksWraps[i2];
      ...
      const formMainWrapper = document.querySelector(".contact_main-wrap");
  ...
  var initAccordian = () => {
    ...
    for (let i2 = 0; i2 < servicesImages.length; i2++) {
      const temp = servicesImages[i2];
      if (i2 > 0) {
  ...
  var accordianList = () => {
    ...
    const servicesImages2 = [...document.querySelectorAll(".home-services_image")];
    for (let i2 = 0; i2 < services3.length; i2++) {
      let getImage2 = function(service) {
        const defaultImage = servicesImages2[0];
        let image = defaultImage;
        for (const item in servicesImages2) {
          const tempImage = servicesImages2[item];
          const tempParent = tempImage.parentElement;
      ...
      var getImage = getImage2;
      let isOpen = false;
      const temp = services3[i2];
      ...
      temp.addEventListener("mouseenter", (e2) => {
        ...
        const changeImage = getImage2(curService);
    ...
    servicesContainer.addEventListener("mousemove", (e2) => {
      accordianImageHover(e2.clientX, e2.clientY);
    });
  };
  ...
  var initSliderContent = () => {
    for (let i2 = 0; i2 < pInfoParent.length; i2++) {
      const parentTemp = pInfoParent[i2];
      const itemTemp = pInfoItem[i2];
      const numberTemp = pNumbers[i2];
      numberTemp.innerHTML = "0" + (i2 + 1);
      if (i2 > 0) {
  ...
  var heroScroll = () => {
    ...
    const homeHeroSection = document.querySelector(".section_home-hero");
    const maskedComponent = homeHeroSection.querySelector(
      ".home-hero_masked-component"
    );
    const scrolledComponent = homeHeroSection.querySelector(".home-hero_scrolled");
  ...
  var heroZText = () => {
    ...
    const maskedTrack = heroSection.querySelector(".home-hero_text-track");
    const bgTrack = heroSection.querySelector(".bg-text_track");
    const maskedChildren = [...maskedTrack.childNodes];
    const bgChildren = [...bgTrack.childNodes];
    const midChildren = [];
    const outChildren = [];
    for (let i2 = 0; i2 < 3; i2++) {
      const maskedTemp = maskedChildren[i2];
      const bgTemp = bgChildren[i2];
  ...
  var ScrollToPlugin = {
    ...
    init: function init5(target, value, tween, index, targets) {
      ...
      ScrollTrigger3 || (ScrollTrigger3 = gsap8.core.globals().ScrollTrigger);
  ...
  var setDeepLinks = () => {
    ...
    for (const i2 in serviceSections) {
      const temp = serviceSections[i2];
      const tempTitle = temp.querySelector("h3");
      const titleText = tempTitle.innerHTML;
      const serviceTag = titleText.split(" ")[0];
      const tempButton = temp.querySelector(".home-services_button-wrap")?.children[0];
  ...
  var servicesPageReveal = () => {
    const fixedHeaderSection = document.querySelector(".section_sticky-header");
    const heroSection = document.querySelector(".section_services-hero");
    const heroTitle = fixedHeaderSection.querySelector("h1");
    const headerSplit = new SplitText(heroTitle, { type: "lines", linesClass: "lineChild" });
    const textSplitParent = new SplitText(heroTitle, {
      type: "lines",
  ...
  var serviceSectionReveal = () => {
    ...
    const headerAnimation = gsapWithCSS.timeline({
      scrollTrigger: {
