...
(() => {
  ...
  var footer = () => {
    ...
    const footer2 = document.querySelector(".footer_component");
    const footerHeight = parseInt(getComputedStyle(footer2).height.split("px")[0]) - 64;
    const bottomRadius = footerSpacer.style.height = footerHeight + "px";
    window.addEventListener("resize", () => {
      const footerHeight2 = parseInt(getComputedStyle(footer2).height.split("px")[0]) - 64;
      footerSpacer.style.height = footerHeight2 + "px";
    });
  ...
  var links = () => {
    ...
    gsapWithCSS.set([footer2, nav], { display: "none" });
    console.log("LINKS", footer2);
  };
