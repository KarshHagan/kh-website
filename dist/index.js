...
(() => {
  ...
  var loadContent = () => {
    ...
    init6();
    loadButton.addEventListener("click", (e2) => {
      console.log(e2);
      renderUpdate();
    });
    function init6() {
      ...
      transitionItem = loadItems[curVisible - 1];
    ...
    function renderUpdate() {
      ...
      for (let i2 = 0; i2 < curVisible; i2++) {
        ...
        if (tempItem.style.display === "none") {
          gsapWithCSS.set(tempItem, { display: "grid", opacity: 0, y: "2rem" });
    ...
    function revealLoad(newElements) {
